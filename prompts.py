...
FORBIDDEN_VERBS = ["inspect", "check", "look", "examine", "reach", "grab", "rotate", "relocate"]
...
- if a label violates Tier-3 phrasing, rewrite that label from scratch instead of patching bad shorthand
...
5) no forbidden verbs: inspect/check/look/examine/reach/grab/rotate/relocate
...
- imperative labels
- no numerals
- no forbidden verbs: inspect/check/look/examine/reach/grab/rotate/relocate
